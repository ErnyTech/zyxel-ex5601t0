...
define Device/ex5512-t0
  DEVICE_VENDOR := ZYXEL
  DEVICE_MODEL := ex5512-t0 (SPI-NAND,UBI)
  DEVICE_DTS := ex5512-t0
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7986b-spim-snand-ex5512-t0
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 256k
  PAGESIZE := 4096
  IMAGE_SIZE := 65536k
