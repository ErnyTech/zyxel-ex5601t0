...
ifeq ($(DUMP),1)
  ...
  ifeq ($(TARGET_BUILD),1)
    ...
    ZYXEL_PATCH_DIR ?= $(CURDIR)/zyxel-patches$(if $(wildcard ./patches-$(KERNEL_PATCHVER)),-$(KERNEL_PATCHVER))
  ...
  ifneq ($(call qstrip,$(CONFIG_ZYXEL_EXTERNAL_TARBALL_SERVER)),)
      LINUX_SITE:=@ZyXEL_SITE/kernel/$(word 1,$(subst ., ,$(KERNEL_BASE))).x
