...
KERNEL_FILE_DEPENDS=$(GENERIC_BACKPORT_DIR) $(GENERIC_PATCH_DIR) $(GENERIC_HACK_DIR) $(PATCH_DIR) $(ZYXEL_PATCH_DIR) $(GENERIC_FILES_DIR) $(FILES_DIR)
...
define BuildKernel
  ...
  fcs: FORCE
	$(MAKE) -C image fcs ZYXEL_FCS=1 TARGET_BUILD=
