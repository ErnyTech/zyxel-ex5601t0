...
$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_ZEXTMARK, $(P_XT)xt_zextmark))
...
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_ZEXTMARK, $(P_XT)xt_ZEXTMARK)))
...
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_CONNZEXTMARK, $(P_XT)xt_connzextmark))
...
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_CONNZEXTMARK, $(P_XT)xt_CONNZEXTMARK)))
...
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_ZEXTMARK, $(P_EBT)ebt_zextmark_m))
...
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_ZEXTMARK_T, $(P_EBT)ebt_zextmark))
