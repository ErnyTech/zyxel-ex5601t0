...
define Kernel/Patch/Default
	...
	$(call PatchDir,$(LINUX_DIR),$(ZYXEL_PATCH_DIR),zyxel/)
endef
...
define Quilt/Refresh/Kernel
	@[ -z "$$(grep -v '^generic/' $(PKG_BUILD_DIR)/patches/series | grep -v '^platform/' | grep -v '^zyxel/')" ] || { \
	...
	$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(ZYXEL_PATCH_DIR),zyxel/)
endef
