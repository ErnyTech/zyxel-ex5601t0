...
$hash_cmd or ($file_hash eq "skip") or ($file_hash eq "x") or die "Cannot find appropriate hash command, ensure the provided hash is either a MD5 or SHA256 checksum.\n";
