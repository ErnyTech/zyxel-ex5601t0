...
dal_param_t MGMT_SRV_PASSTHRU_param[]={		//RDM_OID_REMO_SRV_IP_PASS_THRU
	...
	{"Mode", 					dalType_string,	0,	0,		NULL, "IPPT_ONLY|IPPT_WAN|None", 	0},
...
zcfgRet_t zcfgFeDal_mgmtSrvPassthru_Get(struct json_object *Jobj, struct json_object *Jarray, char *replyMsg){
...
void zcfgFeDalShowMgmtSrvPassthru(struct json_object *Jarray){
...
zcfgRet_t zcfgFeDal_mgmtSrvPassthru_Edit(struct json_object *Jobj, char *replyMsg){
	zcfgRet_t ret = ZCFG_SUCCESS;
...
zcfgRet_t zcfgFeDalMgmtSrvPassthru(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg){
	zcfgRet_t ret = ZCFG_SUCCESS;
	if(!strcmp(method, "PUT"))
		ret = zcfgFeDal_mgmtSrvPassthru_Edit(Jobj, replyMsg);
	else if(!strcmp(method, "GET"))
		ret = zcfgFeDal_mgmtSrvPassthru_Get(Jobj, Jarray, NULL);
	else
