...
#define hidden_extender_dalcmd 1
#define hidden_extender_dalcmd_param 1 << 7
#else
#define hidden_extender_dalcmd 0
#define hidden_extender_dalcmd_param  0
#endif
...
extern int highIdx;
extern int mediumIdx;
extern int lowIdx;
extern int vullIdx;
extern int telek0mIdx;
#endif
...
typedef struct dal_handler_s {
	...
	void					(*showfunc)(struct json_object *);
	char				*method;
	char				*previlege;
	uint8_t				previlegebyFlag;
}dal_handler_t;
