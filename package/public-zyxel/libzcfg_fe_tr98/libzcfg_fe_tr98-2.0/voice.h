...
tr98Parameter_t para_VoiceProf[] = {
	...
	{ "X_ZYXEL_Region_IntlPhoneNumCallingCode", PARAMETER_ATTR_WRITE, 17, json_type_string}, //Michael.20190604.001: Add to support a Manually-Configurable/Customized International PhoneNumber Calling Code parameter for the PlusSign(+)-beginning (International) PhoneNumber CLID Display Process Logic. Related Tickets: [#190400265][#105337][VMG8825-B60B][Generic][DE], [#190401061][#105665][VMG8825-T50K][TAAAE].
	{ "X_ZYXEL_Region_CarrierSelectionCode", PARAMETER_ATTR_WRITE, 129, json_type_string},
	{ "X_ZYXEL_EmergencyNumberList", PARAMETER_ATTR_WRITE, 129, json_type_string},
	...
	{ "X_ZYXEL_VoipSigIOPFlags", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "X_ZYXEL_VoipMediaIOPFlags", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
...
tr98Parameter_t para_VoiceProfSip[] = {
	...
	{ "X_ZYXEL_Rfc3263_DNS_Method", PARAMETER_ATTR_WRITE, 16, json_type_string},
#endif
	{ "X_ZYXEL_ConferenceURI", PARAMETER_ATTR_WRITE, 257, json_type_string},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_VoiceLineProcessing[] = {
	...
	{ "X_ZYXEL_VoiceJBMode", PARAMETER_ATTR_WRITE, 65, json_type_string},
	{ "X_ZYXEL_VoiceJBMin", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "X_ZYXEL_VoiceJBMax", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "X_ZYXEL_VoiceJBTarget", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "X_ZYXEL_DataJBMode", PARAMETER_ATTR_WRITE, 65, json_type_string},
	{ "X_ZYXEL_DataJBTarget", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_VoicePhyIntf[] = {
...
#endif
	{ "X_ZYXEL_HookState", PARAMETER_ATTR_READONLY, 32, json_type_string},
	...
	{ "X_ZYXEL_Pound", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_HookFlashIgnore", PARAMETER_ATTR_WRITE, 0, json_type_boolean}, //Michael.20190301.002: Add to Support to Disable/Remove the Phone Hook Flash function by Using a (PhyInterface-level dedicated) Parameter 'X_ZYXEL_HookFlashIgnore' to Ignore the Phone Hook Flash Event. Related Tickets: [eITS#170700466][#39697][HTC], [eITS#180901009][Altibox] and [eITS#181100069][#68892][EU Generic].
	{ NULL, 0, 0, 0}
};
tr98Parameter_t para_VoiceFxsCID[] = {
	{ "FxsCIDMsgFormat", PARAMETER_ATTR_WRITE, 65, json_type_string},
	{ "FxsCIDEmptyCallerNameHandlePolicy", PARAMETER_ATTR_WRITE, 65, json_type_string},
};
...
tr98Parameter_t para_VoiceCallPolicyBook[] = {
	{ "ExceptNumberList", PARAMETER_ATTR_WRITE, 257, json_type_string},
	{ "BlockInternationalCall", PARAMETER_ATTR_WRITE, 33, json_type_string},
	{ NULL, 0, 0, 0}
};
...
extern zcfgRet_t voiceNotify(char *tr98ObjName, char *tr181ParamName, struct json_object *tr181ParamVal, int handler, struct json_object **tr98NotifyInfo);
...
extern zcfgRet_t voiceProfSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceProfSipSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceProfNumPlanObjSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceProfFaxT38ObjSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceLineSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceLineSipSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceLineCallingFeatureObjSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceLineProcSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
extern zcfgRet_t voiceLineCodecListObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault);
...
extern zcfgRet_t voicePhyIntfSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
...
/* InternetGatewayDevice.Services.VoiceService.i.PhyInterface.i.X_ZYXEL_CID */
extern zcfgRet_t voiceFxsCIDObjGet(char * tr98FullPathName,int handler,struct json_object * * tr98Jobj,bool updateFlag);
extern zcfgRet_t voiceFxsCIDObjSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
extern int voiceFxsCIDAttrGet(char *tr98FullPathName, int handler, char *paramName);
extern zcfgRet_t voiceFxsCIDAttrSet(char *tr98FullPathName, int handler, char *paramName, int newNotify, struct json_object *multiAttrJobj);
...
extern zcfgRet_t voiceCommonSet(char * tr98FullPathName,int handler,struct json_object * tr98Jobj,struct json_object * multiJobj, char *paramfault);
#if 0
...
/* InternetGatewayDevice.Services.VoiceService.i.X_ZYXEL_VoicePhoneBook.CallPolicyBook */
extern zcfgRet_t voiceCallPolicyBookObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t voiceCallPolicyBookObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault);
