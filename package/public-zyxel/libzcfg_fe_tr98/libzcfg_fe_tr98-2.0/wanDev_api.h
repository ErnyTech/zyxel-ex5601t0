...
zcfgRet_t dnsAddJobj(char *, objIndex_t *, struct json_object **, bool);
#endif
...
zcfgRet_t multiObjIpIfaceAdd(char *, char *, struct json_object *, int);
#else
zcfgRet_t multiObjIpIfaceAdd(char *, char *, struct json_object *);
#endif
#ifdef CONFIG_TAAAB_CUSTOMIZATION
zcfgRet_t multiObjPppIfaceAdd(char *, char *, struct json_object *, int);
#else
...
zcfgRet_t checkWANType(objIndex_t, rdm_IpIface_t *, char*, uint8_t*);
#endif
#endif
