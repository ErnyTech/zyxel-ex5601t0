...
extern zcfgRet_t devInfoObjSet(char *, int , struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t devInfoVendorCfgObjSet(char *, int , struct json_object *, struct json_object *, char *);
