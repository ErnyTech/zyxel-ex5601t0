tr98Parameter_t para_DevInfo[] = {
    ...
    { "X_TTNET_SerialNumber", PARAMETER_ATTR_READONLY, 65, json_type_string},
    { "X_TTNET_MACAddress", PARAMETER_ATTR_READONLY, 17, json_type_string},
#endif
...
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069
    { "X_TTNET_FR_ReasonCode", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
    { "X_TTNET_FR_Date", PARAMETER_ATTR_READONLY, 15, json_type_string},
    { "X_TTNET_FR_Count", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
    { "X_TTNET_RB_ReasonCode", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
    { "X_TTNET_RB_Date", PARAMETER_ATTR_READONLY, 15, json_type_string},
    { "X_TTNET_RB_Count", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
#endif
	...
	{ "DSLVersion", PARAMETER_ATTR_READONLY, 65, json_type_string},
#endif
	{ NULL, 0, 0, 0}
};
