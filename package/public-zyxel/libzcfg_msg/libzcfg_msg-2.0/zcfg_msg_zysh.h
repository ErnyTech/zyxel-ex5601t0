...
#define ZCFG_ZYSH_CMD_IPERF			31
#define ZCFG_ZYSH_CMD_MODULE_DEBUG  32
#define ZCFG_ZYSH_CMD_ROOT_WRAPPER  33
...
#define ZCFG_ZYSH_CMD_EXE			0
#define ZCFG_ZYSH_CMD_KILL			(1 << 0)
#define ZCFG_ZYSH_CMD_QUIET			(1 << 1)
