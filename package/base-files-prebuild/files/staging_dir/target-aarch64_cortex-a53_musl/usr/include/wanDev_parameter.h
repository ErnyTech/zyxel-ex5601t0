...
tr98Parameter_t para_WANDslIfaceCfg[] = {
	...
	{ "X_ZYXEL_EOC_VENDOR_ID", PARAMETER_ATTR_WRITE, 33, json_type_string},
	{ "X_ZYXEL_EOC_SERIAL", PARAMETER_ATTR_WRITE, 33, json_type_string},
	{ "X_ZYXEL_EOC_VERSION", PARAMETER_ATTR_WRITE, 33, json_type_string},
#endif
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_WANEthIntfConf[] = {
	...
	{ "X_ZYXEL_UpTime", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "X_ZYXEL_LastChangeTime", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_RUNNINGWANConn[] = {
	{ "Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
   ...
   // { "X_ZYXEL_IfName", PARAMETER_ATTR_READONLY, 18, json_type_string},
	...
	{ "LinkType", PARAMETER_ATTR_WRITE, 14, json_type_string},
	{ "ATMEncapsulation", PARAMETER_ATTR_WRITE, 7, json_type_string},
	{ "DataConnectionInterface", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ NULL, 0, 0, 0}
};
#endif //ZYXEL_RUNNINGWAN_CUSTOMIZATION
...
tr98Parameter_t para_WANIpConn[] = {
	...
	{ "X_ZYXEL_DNSType", PARAMETER_ATTR_WRITE, 19, json_type_string},
	{ "X_ZYXEL_IGMPProxyEnable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_MLDProxyEnable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_VlanEnable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_VlanMux8021p", PARAMETER_ATTR_WRITE, 0, json_type_int},
	{ "X_ZYXEL_VlanMuxID", PARAMETER_ATTR_WRITE, 0, json_type_int},
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069
	{ "X_TTNET_Bootp_Flag", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
#endif
#ifdef CONFIG_TAAAB_DSL_BINDING
    { "X_TT_802_1p", PARAMETER_ATTR_WRITE, 0, json_type_int},
    { "X_TT_VLANID", PARAMETER_ATTR_WRITE, 0, json_type_int},
#endif
#ifdef ZYXEL_TAAAG_FIREWALL_WANINTERFACE
	{ "X_ZYXEL_Enable_Firewall", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif
	{ "X_ZYXEL_FullConeEnabled", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	...
	{ "X_ZYXEL_IPv6DNSEnabled", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_IPv6DNSServers", PARAMETER_ATTR_WRITE, 65, json_type_string},
	{ "X_ZYXEL_DNSV6Type", PARAMETER_ATTR_WRITE, 19, json_type_string},
	{ "X_ZYXEL_IPv6AddressNumberOfEntries", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "X_ZYXEL_IPv6PrefixNumberOfEntries", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "X_ZYXEL_IPv6DefaultGatewayIface", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_Enable_DSLite", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "X_ZYXEL_DSLiteRelayIPv6Addresses", PARAMETER_ATTR_WRITE, 73, json_type_string},
	{ "X_ZYXEL_DSLite_Type", PARAMETER_ATTR_WRITE, 8, json_type_string},
#endif
...
#endif
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069 
	{ "X_TTNET_counter", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "X_TTNET_ConnectionDown", PARAMETER_ATTR_WRITE, 64, json_type_string},
#endif
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_ReqDhcpOpt[] = {
	...
	{ "Tag", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069 
	{ "Value", PARAMETER_ATTR_READONLY, 256, json_type_string},
#else
...
tr98Parameter_t para_WANWwanIntfConf[] = {
	...
	{ "PINVerification", PARAMETER_ATTR_READONLY, 32, json_type_string},
	...
	{ "BackupInterval", PARAMETER_ATTR_WRITE, 0, json_type_int},
	{ "RecoveryInterval", PARAMETER_ATTR_WRITE, 0, json_type_int},
	{ "CheckedDefaultGateway", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "CheckedIPAddr", PARAMETER_ATTR_WRITE, 32, json_type_string},
	{ NULL, 0, 0, 0}
};

tr98Parameter_t para_WANWwanIntfStatsConf[] = {
	{ "BackupInterface", PARAMETER_ATTR_READONLY, 0, json_type_string},
	{ "ServiceProvider", PARAMETER_ATTR_READONLY, 0, json_type_string},
	{ "NetworkName", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "DeviceStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "NetworkRegistrationStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "SIMStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "PINtatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "SIMCardLocked", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "SignalStrength", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "SignalQuality", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "DeviceManufacturer", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "DeviceModelName", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "DeviceFirmwareVersion", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "DeviceIMEI", PARAMETER_ATTR_READONLY, 0, json_type_string},
	{ "SIMCardIMSI", PARAMETER_ATTR_READONLY, 0, json_type_string},
	{ "DeviceESN", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ValidErrorPINTimes", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ValidErrorPUKTimes", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ConnectionUpTime", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "BytesSent", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "BytesReceived", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "CellsSent", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "CellsReceived", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ErrorsSent", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ErrorsReceived", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "DongleMode", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};
