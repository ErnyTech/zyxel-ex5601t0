...
extern zcfgRet_t firewallObjSet(char *, int , struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t firewallLevelObjSet(char *, int , struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t firewallChainObjSet(char *, int , struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t firewallRuleObjSet(char *, int , struct json_object *, struct json_object *, char *);
