...
* 12-Feb-20  Rainy Raniyal     CSR00154929     Fix for allowing string length upto 128 in auth key and password
* Copyright 2020, Aricent.                       
*                                        
*******************************************************************************/
...
/*CSR00154929 fix starts*/
/*-----------------------------------------------------------------------------
 * 
 * Structure Name: icf_auth_string_st
 * 
...
typedef struct        
{
   /* specifies the length of the string including '\0' character */ 
    ...
    /* array of characters */ 
    icf_uint8_t str[ICF_MAX_STR_LEN + 1];
} icf_auth_string_st;

/*CSR00154929 fix ends*/
...
#define ZYXEL_IOP_FLAG_IGNORE_CHECK_CONTACT_URL_IN_REGISTER_200OK	(1 << 2) //Mapping to VOIP_SIG_IOP_FLAG_IGNORE_CHECK_CONTACT_URL_IN_REGISTER_200OK.
#define ZYXEL_IOP_FLAG_NOT_DEL_SDP_RECORD_WHEN_RECV_NO_SDP_REINVITE_FOR_CALL_RESUME	(1 << 3) //ZYXEL_SIP_NOT_DEL_SDP_RECORD_WHEN_RECV_NO_SDP_REINVITE_FOR_CALL_RESUME //Amber.20201015: Add for receiving re-INVITE without SDP will clean the previous negotiated SDP then send 'get codec list' request to application like first INVITE.
