...
#include "syscall_wrapper.h" //Michael.20220410.003: Add to Merge RD-Ado's modification(s) to Avoid [voiceApp]/[mm.exe] Crashes because of the (Possible Root Cause) 'Memory Address Error' under the Full 64-bit operation system.
...
#include <arpa/inet.h>	//Fix the inet_ntoa() error on 64-bit machine. //Michael.20220410.003: Add to Merge RD-Ado's modification(s) to Avoid [voiceApp]/[mm.exe] Crashes because of the (Possible Root Cause) 'Memory Address Error' under the Full 64-bit operation system.
