...
#if 0 //Michael.20200114.003: Remarked All the definitions of 'NUM_XXX_CHANNELS' in 'Endpoint_func.h' & 'tr104_object.h' to directly refer to the (corresponding) ones defined in the 'switch.h'.
...
#define VOICE_CAP_REGIONS_MAX_LENGTH	(256+1)
...
typedef	struct VoiceCapObj_st{/*R*/
	...
	char 	regions[VOICE_CAP_REGIONS_MAX_LENGTH];
	uint8	RTCP;	
	uint8	SRTP;
...
typedef enum
{
    ...
    DOMAIN = 2,
    SELECTED_SRV = 3
} REG_SIP_FIELD_MODE_e;

#if ZYXEL_VOIP_RUNTIME_CHANGE_THE_DATA_SOURCE_OF_1DNS_QUERY_NAME_AND_2REGISTER_REQUEST_URI_SUPPORT
typedef enum
{
    DNS_QUERY_NAME_BASE_SERVICE_DOMAIN = 0,
    DNS_QUERY_NAME_BASE_MANUAL_SERVER_ADDR = 1
}DNS_QueryNameBase_e;

#define DNS_QUERY_NAME_BASE_SERVICE_DOMAIN_STR "ServiceDomain"
#define DNS_QUERY_NAME_BASE_MANUAL_SERVER_ADDR_STR "ManualServerAddr"

typedef enum
{
    SIP_REGISTER_REQUEST_URI_AUTO = AUTO,
    SIP_REGISTER_REQUEST_URI_MANUAL_REGISTRAR_ADDR = MANUAL,
    SIP_REGISTER_REQUEST_URI_SERVICE_DOMAIN = DOMAIN,
    SIP_REGISTER_REQUEST_URI_SELECTED_DNS_RSP_ADDR = SELECTED_SRV
}REGISTER_RequestURIBase_e;

#define SIP_REGISTER_REQUEST_URI_AUTO_STR "Auto"
#define SIP_REGISTER_REQUEST_URI_MANUAL_REGISTRAR_ADDR_STR "ManualRegistrarAddr"
#define SIP_REGISTER_REQUEST_URI_SERVICE_DOMAIN_STR "ServiceDomain"
#define SIP_REGISTER_REQUEST_URI_SELECTED_DNS_RSP_ADDR_STR "SelectedDnsRspAddr"
#endif //ZYXEL_VOIP_RUNTIME_CHANGE_THE_DATA_SOURCE_OF_1DNS_QUERY_NAME_AND_2REGISTER_REQUEST_URI_SUPPORT.

//Amber.20200807.B: Add for SIP URL append 'user=phone' to (1) To header of REGISTER and in-dialog SIP Method; (2) From header of SIP Method ; (3) Reqest-Line of in-dialog SIP Method.
#if ZYXEL_SIP_URL_ADD_USER_PHONE_PARAM
typedef enum sip_url_add_user_phone_rule_es
{
	TR104I_SIP_URL_ADD_USER_PHONE_PARAM_RULE_DISABLED = 0,
	TR104I_SIP_URL_ADD_USER_PHONE_PARAM_RULE_PLUS_SIGN_PHONE_NUM,
	TR104I_SIP_URL_ADD_USER_PHONE_PARAM_RULE_ALWAYS
} sip_url_add_user_phone_rule_et;

#define TR104S_SIP_URL_ADD_USER_PHONE_PARAM_RULE_DISABLED					"Disabled"
#define TR104S_SIP_URL_ADD_USER_PHONE_PARAM_RULE_PLUS_SIGN_PHONE_NUM		"PlusSignPhoneNum"
#define TR104S_SIP_URL_ADD_USER_PHONE_PARAM_RULE_ALWAYS						"Always"
#endif //ZYXEL_SIP_URL_ADD_USER_PHONE_PARAM.
//Amber.20200807.E: Add for SIP URL append 'user=phone' to (1) To header of REGISTER and in-dialog SIP Method; (2) From header of SIP Method ; (3) Reqest-Line of in-dialog SIP Method.
...
//Amber.20200622: Add for RFC3263 NAPTR Support.
#if ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT
	int		ZyXEL_rfc3263_DNS_Method;
	uint8	ZyXEL_rfc3263_TTLRefreshDnsMethodBase; //Bitwise to indicate DNS method
	uint8	ZyXEL_rfc3263_TTLRefreshResultUsagePolicy;
	uint32	ZyXEL_rfc3263_TTLRefreshHeadStartTime;
#endif //ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT.
...
//Amber.20190619: Add.
#define HEARTBEAT_RATE_MAX	86400 //sec.
#define HEARTBEAT_RATE_MIN	1 //sec.
#define HEARTBEAT_RATE_DEFAULT	45 //sec.
#endif	
...
#if ZYXEL_VOIP_RUNTIME_CHANGE_THE_DATA_SOURCE_OF_1DNS_QUERY_NAME_AND_2REGISTER_REQUEST_URI_SUPPORT
	uint8 ZyXEL_DNS_QueryNameBase;
	uint8 ZyXEL_REGISTER_RequestURIBase;
#endif //ZYXEL_VOIP_RUNTIME_CHANGE_THE_DATA_SOURCE_OF_1DNS_QUERY_NAME_AND_2REGISTER_REQUEST_URI_SUPPORT.
...
//Amber.20200622: Add for RFC3263 NAPTR Support.
#if ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT
	int ZyXEL_rfc3263_op120Server_DNS_Method;
#endif //ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT.
...
#if ZYXEL_SIP_SERVER_BACKUP_METHOD_MANUAL_CONFIG_DUAL_FQDN_SERVER_BACKUP_SWITCH
	/*20181030 Ralph: Add Backup Server domain*/
	char ZYXEL_BackupServer[SIP_DOMAIN_NAME_LEN+1];
#endif

	char	ZyXEL_RetryAfter_ResponseList_REGISTER[128+1]; //Amber.20200217: Add for support retry REGISTER time can using the time in 'Retry-After' header of 500 and 503 response.

#if ZYXEL_SIP_URL_ADD_USER_PHONE_PARAM //Amber.20200807: Add for SIP URL append 'user=phone' to (1) To header of REGISTER and in-dialog SIP Method; (2) From header of SIP Method ; (3) Reqest-Line of in-dialog SIP Method.
	uint8	ZyXEL_SipUrlAddUserPhoneParamRule;
#endif
}VoiceProfSipObj_t;
...
#define TONE_EVENT_UNKNOWN			0xFF //Michael.20191124.001: Add to support the 3GPP IMS Dial-tone Management feature defined in the Spec. ETSI TS 183.043.
#define TONE_EVENT_BUSY				0
#define TONE_EVENT_CONFIRMATION		1
#define TONE_EVENT_DIAL				2
#define TONE_EVENT_MWIDIAL			25 //Michael.20191204.001: Add to have a Better and Correct MWI Dial-tone Playing function Part-3a: Make the VoIP Debug CLI support to play the MWI Dial-tone.
#define TONE_EVENT_MESSAGEWAITING	3
#define TONE_EVENT_OFFHOOKWARNING	4 //Howler-tone.
#define TONE_EVENT_RINGBACK			5
#define TONE_EVENT_REORDER			6
#define TONE_EVENT_STUTTERDIAL		7 //Michael.20191204.001: For ZyIMS VoIP, this Tone Event is designed to be mapped/equivalent to the 'MWI Dial-tone'!!
...
#define TONE_EVENT_CNT					26
#define TONE_EVENT_MAX					TONE_EVENT_CNT
#define TONE_EVENT_BEGIN				TONE_EVENT_BUSY
//Michael.20150909.001.E: Add.

//Michael.20191207.002.B: Add to support the Utility function 'sys_misc.c/tr104ToneEventToName()' to Convert/Map the TR104-defined Tone Event Id (tr104_object.h/TONE_EVENT_XXXXXX) to its Representative Name String. Meanwhile, this Utility function could also be accessed/utilized from all ZyIMS VoIP module parts, including the Debug CLI.
#define TR104S_TONE_EVENT_UNKNOWN			"Unknown"		// 0xFF (255).
#define TR104S_TONE_EVENT_BUSY				"Busy"			// 0.
#define TR104S_TONE_EVENT_CONFIRMATION		"Confirm"		// 1.
#define TR104S_TONE_EVENT_DIAL				"(Normal) Dial"	// 2.
#define TR104S_TONE_EVENT_MWIDIAL			"MWI Dial"		// 25.
#define TR104S_TONE_EVENT_MESSAGEWAITING	"MWI"			// 3.
#define TR104S_TONE_EVENT_OFFHOOKWARNING	"Howler"			// 4.
#define TR104S_TONE_EVENT_RINGBACK			"Ringback"		// 5.
#define TR104S_TONE_EVENT_REORDER			"ReOder"			// 6.
#define TR104S_TONE_EVENT_STUTTERDIAL		"Stutter Dial"		// 7.
#define TR104S_TONE_EVENT_CALLWT				"Call Waiting"		// 21.
#define TR104S_TONE_EVENT_CW1					"Call Waiting-1"	// 8.
#define TR104S_TONE_EVENT_CW2					"Call Waiting-2"	// 9.
#define TR104S_TONE_EVENT_CW3					"Call Waiting-3"	// 10.
#define TR104S_TONE_EVENT_CW4					"Call Waiting-4"	// 11.
#define TR104S_TONE_EVENT_ALERTINGSIGNAL		"Alert Signal"		// 12.
#define TR104S_TONE_EVENT_SPECIALDIAL		"Special Dial"		// 13.
#define TR104S_TONE_EVENT_SPECIALINFO		"Special Info"		// 14.
#define TR104S_TONE_EVENT_RELEASE				"Release"			// 15.
#define TR104S_TONE_EVENT_CONGESTION			"Congest"		// 16.
#define TR104S_TONE_EVENT_USERDEF1			"User Define-1"	// 17.
#define TR104S_TONE_EVENT_USERDEF2			"User Define-2"	// 18.
#define TR104S_TONE_EVENT_USERDEF3			"User Define-3"	// 19.
#define TR104S_TONE_EVENT_USERDEF4			"User Define-4"	// 20.
#define TR104S_TONE_EVENT_WARNING			"Warning"		// 22.
#define TR104S_TONE_EVENT_POSITIVE_ACK		"Postive ACK"		// 23.
#define TR104S_TONE_EVENT_NEGATIVE_ACK		"Negative ACK"	// 24.
//<==> sys_misc.h&c/const char* tr104ToneEventIdToName(uint8 toneEvtId);
//Michael.20191207.002.E: Add.
...
#if ZYXEL_VOICE_DSP_JITTER_BUFFER_SUPPORT
typedef enum
{
    VOICE_JITTER_BUFFER_MODE_DEFAULT,
    VOICE_JITTER_BUFFER_MODE_FIXED,
    VOICE_JITTER_BUFFER_MODE_ADAPTIVE
} VOICE_JITTER_BUFFER_MODE_e;

#define VOICE_JITTER_BUFFER_MODE_DEFAULT_STR    "Default"
#define VOICE_JITTER_BUFFER_MODE_FIXED_STR      "Fixed"
#define VOICE_JITTER_BUFFER_MODE_ADAPTIVE_STR   "Adaptive"

typedef enum
{
    DATA_JITTER_BUFFER_MODE_DEFAULT,
    DATA_JITTER_BUFFER_MODE_FIXED
} DATA_JITTER_BUFFER_MODE_e;

#define DATA_JITTER_BUFFER_MODE_DEFAULT_STR    "Default"
#define DATA_JITTER_BUFFER_MODE_FIXED_STR      "Fixed"
#endif //ZYXEL_VOICE_DSP_JITTER_BUFFER_SUPPORT.
...
typedef struct VoiceProfLineStatsObj_st{/*R*/
	...
	char LastIncommingNumber[65]; /*readonly, this record including Missed Incoming call.*/
	char LastOutgoingNumber[65]; /*readonly, this record including Non-Established Outgoing call.*/
	bool MWIStatus;
...
#if ZYXEL_VOIP_VBD_NOT_TO_SEND_MEDIA_CHANGE_SIP_REQ_IF_CODEC_SAME_AS_EXISTING_AUDIO_CALL //Amber.20201109: Add for PT fax not to send re-INVITE if audio codec is same with PT fax codec.
typedef enum zyxelVBDMediaChangeSigSendPolicy_es
{
	TR104I_VBD_MEDIA_CHANGE_SIGNAL_SEND_POLICY_ALWAYS, // 0.
	TR104I_VBD_MEDIA_CHANGE_SIGNAL_SEND_POLICY_ONLY_DIFF_CODEC, // 1.
} zyxelVBDMediaChangeSigSendPolicy_et;

#define TR104S_VBD_MEDIA_CHANGE_SIGNAL_SEND_POLICY_ALWAYS "Always"
#define TR104S_VBD_MEDIA_CHANGE_SIGNAL_SEND_POLICY_ONLY_DIFF_CODEC "OnlyDiffCodec"
#endif //ZYXEL_VOIP_VBD_NOT_TO_SEND_MEDIA_CHANGE_SIP_REQ_IF_CODEC_SAME_AS_EXISTING_AUDIO_CALL.

#if ZYXEL_VOIP_VBD_MEDIA_CHANGE_SIP_REQ_METHOD_TYPE_CONTROL_SUPPORT //Amber.20201109: Add for change FAX Request Method to use SIP UPDATE.
typedef enum zyxelVBDMediaChangeSigMethodType_es
{
	TR104I_VBD_MEDIA_CHANGE_SIGNAL_METHOD_TYPE_INVITE, // 0.
	TR104I_VBD_MEDIA_CHANGE_SIGNAL_METHOD_TYPE_UPDATE, // 1
} zyxelVBDMediaChangeSigMethodType_et;

#define TR104S_VBD_MEDIA_CHANGE_SIGNAL_METHOD_TYPE_INVITE "INVITE"
#define TR104S_VBD_MEDIA_CHANGE_SIGNAL_METHOD_TYPE_UPDATE "UPDATE"
#endif //ZYXEL_VOIP_VBD_MEDIA_CHANGE_SIP_REQ_METHOD_TYPE_CONTROL_SUPPORT.

#if ZYXEL_VOIP_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_CONTROL_SUPPORT
typedef enum zyxelVBDMediaChangeMediaSendPolicy_es
{
	TR104I_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_ALWAYS,
	TR104I_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_SUSPEND_BEFORE_SIG
}zyxelVBDMediaChangeMediaSendPolicy_et;

#define TR104S_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_ALWAYS "Always"
#define TR104S_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_SUSPEND_BEFORE_SIG "SuspendBeforeSig"
#endif //ZYXEL_VOIP_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_CONTROL_SUPPORT.

//Amber.20200622.B: Add for RFC3263 NAPTR Support.
#if ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT
typedef enum zyxelDnsMethod_es
{
	TR104I_DNS_METHOD_INVALID = -1,
	TR104I_DNS_METHOD_DISABLE = TR104I_DNS_METHOD_INVALID,
	TR104I_DNS_METHOD_BASIC, // 0
	TR104I_DNS_METHOD_A = TR104I_DNS_METHOD_BASIC, // 0
	TR104I_DNS_METHOD_SRV, // 1
	TR104I_DNS_METHOD_NAPTR, // 2
	TR104I_DNS_METHOD_MAX, // 3
	TR104I_DNS_METHOD_ERROR = TR104I_DNS_METHOD_MAX // 3
} zyxelDnsMethod_et;

#define TR104S_DNS_METHOD_BASIC   "BASIC"
#define TR104S_DNS_METHOD_A       "A"
#define TR104S_DNS_METHOD_SRV     "SRV"
#define TR104S_DNS_METHOD_NAPTR   "NAPTR"
#define TR104S_DNS_METHOD_DISABLE "DISABLE"

/* To decide what kind of changing to the DNS record list should do IPTK Config Refersh.
   StabilityFirst(Default): If the on-using record still exist in new list, IPTK config will not change the server location.
   PriorityFirst: //If the new priority of on-using record is lower than old priority, IPTK config will change to use new server location.
   StrictPriority: //If the highest priority record in new list is not the on-using record, IPTK config will change to use new server location.
*/
typedef enum zyxelDnsTTLRefreshRule_es
{
	TR104I_TTL_REFRESH_RESULT_USAGE_POLICY_STABILITY_FIRST = 0,
	TR104I_TTL_REFRESH_RESULT_USAGE_POLICY_PRIORITY_FIRST, // 1
	TR104I_TTL_REFRESH_RESULT_USAGE_POLICY_STRICT_PRIORITY, // 2
	TR104I_TTL_REFRESH_RESULT_USAGE_POLICY_MAX
} zyxelDnsTTLRefreshRule_et;

#define TR104S_TTL_REFRESH_RESULT_USAGE_POLICY_STABILITY_FIRST "StabilityFirst"
#define TR104S_TTL_REFRESH_RESULT_USAGE_POLICY_PRIORITY_FIRST  "PriorityFirst"
#define TR104S_TTL_REFRESH_RESULT_USAGE_POLICY_STRICT_PRIORITY "StrictPriority"

/* Based on which DNS method to raise the TTL refresh timer.
   All: All of on-using methods will rasie TTL refresh time.
   Highest(Default): Only the highest on-using method will rasie TTL refresh time.
   Lowest: Only the lowest on-using method will rasie TTL refresh time.
   Directly specify DNS Method, e.g. NAPTR,SRV,BASIC.
*/
#define TR104S_TTL_REFRESH_DNS_METHOD_BASE_ALL     "All"
#define TR104S_TTL_REFRESH_DNS_METHOD_BASE_HIGHEST "Highest"
#endif //ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT.
//Amber.20200622.E: Add for RFC3263 NAPTR Support.
...
//#if (ZYXEL_VOIP_PLUS_SIGN_BEGINNING_INTL_TELEPHONE_NUM_CLID_DISPLAY_PROCESS_SUPPORT || ZYXEL_CALL_BLOCK_FUNC_SUPPORT_BLOCK_INTERNATIONAL_CALL)
...
//#endif //ZYXEL_VOIP_PLUS_SIGN_BEGINNING_INTL_TELEPHONE_NUM_CLID_DISPLAY_PROCESS_SUPPORT.
	...
	char	ZyXEL_Region_CarrierSelectionCode[128+1];	//List the carrier selection code in front of the phone number, which is used for checking the call blocking number. Anna 20210115
	char	ZyXEL_EmergencyNumberList[128+1];			//List the emergency phone numbers to be excluded from call blocking list and dialed out immediately. Anna 20210115
...
#endif
#if ZYXEL_VOIP_DIAL_PLAN_POUND_EXTENDED_RULE_SUPPORT //Amber.20200211.Add.
	char	ZyXEL_digitMapPoundExt[256+1];
#endif
	...
	//Michael.20130715.002.E: Add to implement the feature to Originate a Media Change for FAX service.
#if ZYXEL_VOIP_VBD_NOT_TO_SEND_MEDIA_CHANGE_SIP_REQ_IF_CODEC_SAME_AS_EXISTING_AUDIO_CALL //Amber.20201109: Add for PT fax not to send re-INVITE if audio codec is same with PT fax codec.
	uint8	ZyXEL_VBD_MediaChangeSig_SendPolicy; /*Always,OnlyDiffCodec*/
#endif //ZYXEL_VOIP_VBD_NOT_TO_SEND_MEDIA_CHANGE_SIP_REQ_IF_CODEC_SAME_AS_EXISTING_AUDIO_CALL.
#if ZYXEL_VOIP_VBD_MEDIA_CHANGE_SIP_REQ_METHOD_TYPE_CONTROL_SUPPORT //Amber.20201109: Add for change FAX Request Method to use SIP UPDATE.
	uint8	ZyXEL_VBD_MediaChangeSig_MethodType; /*INVITE,UPDATE*/ //!!!!!!NOTE!!!!!!This configuration will be applied to All Voice Profiles!!!
#endif //ZYXEL_VOIP_VBD_MEDIA_CHANGE_SIP_REQ_METHOD_TYPE_CONTROL_SUPPORT.
#if ZYXEL_VOIP_VBD_MEDIA_CHANGE_MEDIA_SEND_POLICY_CONTROL_SUPPORT
	uint8	ZyXEL_VBD_MediaChangeMedia_SendPolicy;
#endif
#if ZYXEL_VOIP_VBD_MEDIA_CHANGE_ATTR_PT_PARAM_GPMD_VBD_PRESENCE_CONTROL_SUPPORT
	bool	ZyXEL_VBD_MediaChangeAttr_PT_Param_gpmd_vbd_yes;
#endif
...
#if ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT
	char		ZyXEL_DNS_Server_List[SIP_SERVER_ADDR_LEN+1]; //Amber.20200622: Add for RFC3263 NAPTR Support.
	uint8		ZyXEL_DNS_Server_Index; //Amber.20200622: Add for RFC3263 NAPTR Support.
#endif //ZYXEL_SIP_RFC3263_DNS_NAPTR_SUPPORT.
...
#if ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT
/*** The valid Caller-ID Message Content Type Key/Keyword(s) ***/
#define FXS_CID_MESSAGE_FORMAT_DATE   "[DateTime]"
#define FXS_CID_MESSAGE_FORMAT_NUMBER "[Number]"
#define FXS_CID_MESSAGE_FORMAT_NAME   "[Name]"
#define FXS_CID_MESSAGE_FORMAT_NONE   "[None]"
#endif //ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT.

#if ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_EMPTY_CALLERNAME_HANDLE_SUPPORT
#define TR104S_FXS_CID_EMPTY_CALLERNAME_REPLACED_BY_ABSENCE_REASON_CODE "ReplacedByAbsenceReasonCode"
#define TR104S_FXS_CID_EMPTY_CALLERNAME_REPLACED_BY_PHONENUMBER         "ReplacedByPhoneNumber"
#define TR104S_FXS_CID_EMPTY_CALLERNAME_KEEP_AS_EMPTY                   "KeepAsEmpty"

typedef enum zyxelfxsCIDEmptyCallerNameHandlePolicy_es
{
	TR104I_FXS_CID_EMPTY_CALLERNAME_HANDLE_NONE=0, // 0:(null) <Default>.
	TR104I_FXS_CID_EMPTY_CALLERNAME_REPLACED_BY_ABSENCE_REASON_CODE, // 1:ReplacedByAbsenceReasonCode,
	TR104I_FXS_CID_EMPTY_CALLERNAME_REPLACED_BY_PHONENUMBER, // 2:ReplacedByPhoneNumber,
	TR104I_FXS_CID_EMPTY_CALLERNAME_KEEP_AS_EMPTY, // 3:KeepAsEmpty,
	TR104I_FXS_CID_EMPTY_CALLERNAME_HANDLE_MAX // 4.
} zyxelfxsCIDEmptyCallerNameHandlePolicy_et;
#endif //ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_EMPTY_CALLERNAME_HANDLE_SUPPORT.


typedef struct ZyXEL_VoiceFxsCIDObj_s
{
#if ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT
	char fxsCIDMsgFormat[65]; //Options (Usually Multiple Choices, except the "[None]". Regardless of the Order): (1)FXS_CID_MESSAGE_FORMAT_DATETIME ("[DateTime]"), (2)_NUMBER ("[Number]"),(3)_NAME ("[Name]"), (4)_NONE ("[None]").

	bool fxsCIDMsgDateEnable; //Including the info of (1)Date (MM/DD) and (2)Time (hh:mm). NO (3)Year!!
	bool fxsCIDMsgNumberEnable;
	bool fxsCIDMsgNameEnable;
#endif //ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT.

#if ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_EMPTY_CALLERNAME_HANDLE_SUPPORT
	uint8 fxsCIDEmptyCallerNameHandlePolicy;
#endif //ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_EMPTY_CALLERNAME_HANDLE_SUPPORT.

	void*	parent_VoicePhyIntfObj;
} ZyXEL_VoiceFxsCIDObj_t;
...
#if ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT
	ZyXEL_VoiceFxsCIDObj_t *ZyXEL_VoiceFxsCIDObj;
#endif //ZYXEL_PHONE_CUSTOMIZED_FXS_CLID_FORMAT_SUPPORT.
...
//#define VOIP_IOP_FLAG_DIAL_PLAN_POUND_EXTENDED_RULE_REMOVE_POUND	(1 << 11) /*ZYXEL_VOIP_DIAL_PLAN_POUND_EXTENDED_RULE_SUPPORT*/ //Amber.20200218: Add for switch the pound key should be removew from SIP message or not.
#define VOIP_IOP_FLAG_DIAL_PLAN_IMMEDIATE_DIAL_REMOVE_LAST_POUND	(1 << 11) /*ZYXEL_VOIP_DIAL_PLAN_SYNTAX_REPEAT_EXTENDED_SUPPORT*/
#define VOIP_IOP_FLAG_DIAL_PLAN_DIGIT_X_INCLUDE_STAR_AND_POUND		(1 << 12) //Michael.20200920.001: Add to Make the Dial Plan (DigitMap) Digit 'X' change to represent the Pure Number Digit 0~9 Only by Default, meanwhile Add a VoIP IOP BitFlag to control to make the Dial Plan Digit 'X' also represent the Digit '*'(Star) & '#'(Pound).
...
#define VOIP_SIG_IOP_FLAG_IGNORE_CHECK_CONTACT_URL_IN_REGISTER_200OK	(1 << 3) //ZYXEL_SIP_IGNORE_CHECK_CONTACT_URL_IN_REGISTER_200OK. //For resolving the issue(s): (1)[eITS#191100781][#118143][VMG9823-B10A MSAC BendTel] SIP Registration Issue, and (2)[eITS#200201162][#124397][VMG9823-B10A MSME BendTel] Option to turn on/off use of Domain Name for SIP register contact.
#define VOIP_SIG_IOP_FLAG_IMMEDIATE_INIT_REGISTER_WHEN_RECV_200OK_EXPIRES_ZERO	(1 << 4) /*ZYXEL_SIP_IMMEDIATE_INITIAL_REGISTER_WHEN_RECV_200OK_EXPIRES_ZERO*/ //Amber.20200825: Add for immediately resend REGISTER to same server when REGISTER resp have ZERO value in (1)Expires header or (2)expires parameter of Contact header.
#define VOIP_SIG_IOP_FLAG_IMMEDIATE_INIT_REGISTER_WHEN_RECV_INVITE_403	(1 << 5) /*ZYXEL_SIP_IMMEDIATE_INITIAL_REGISTER_WHEN_RECV_INVITE_403*/ //Amber.20200821: Add for immediately send REGISTER to same server when INVITE receive 403.
#define VOIP_SIG_IOP_FLAG_IGNORE_PAI_HEADER_TO_GET_CLID_IN_FROM_HEADER	(1 << 6) /*ZYXEL_SIP_IGNORE_PAI_HEADER_TO_GET_CLID_IN_FROM_HEADER*/ //Jake.20200831: Add this VoIP Signal IOP BitFlag '(1 << 6)' to Ignore the information in PAI header and get/retrieve the CLID (Caller-ID) in the FROM header.
#define VOIP_SIG_IOP_FLAG_NOT_DEL_SDP_RECORD_WHEN_RECV_NO_SDP_REINVITE_FOR_CALL_RESUME	(1 << 7) /*ZYXEL_SIP_NOT_DEL_SDP_RECORD_WHEN_RECV_NO_SDP_REINVITE_FOR_CALL_RESUME*/ //Amber.20201015: Add for receiving re-INVITE without SDP will clean the previous negotiated SDP then send 'get codec list' request to application like first INVITE.
#define VOIP_SIG_IOP_FLAG_ALWAYS_INCREASE_SDP_SESSION_VERSION_NUM_FOR_EVERY_OUTGOING_SDP	(1 << 8) //Michael.20201210.002: Add an SIP Signaling-type VoIP IOP BitFlag to control to make the SDP Session Version number Always Increase-by-One for every Outgoing SDP, in order to fix some SDP Session Version related issues.
...
#ifdef ZYXEL_CALL_POLICY_HANDLE_SUPPORT
...
/* The definition for VoicePhoneBookCallPolicyBook_t.incomingCallBlockMode */
typedef enum callPolicyBookMode_es
{
	TR104I_CALL_POLICY_BOOK_MODE_HARDBLOCK = 0,
	TR104I_CALL_POLICY_BOOK_MODE_SOFTBLOCK, // 1
	TR104I_CALL_POLICY_BOOK_MODE_MAX
} callPolicyBookMode_et;

#define TR104S_CALL_POLICY_BOOK_MODE_HARDBLOCK		"HardBlock"
#define TR104S_CALL_POLICY_BOOK_MODE_SOFTBLOCK		"SoftBlock"

/* The definition for VoicePhoneBookCallPolicyBook_t.incomingCallBlock_RespCode */
#define TR104I_CALL_POLICY_BOOK_BLOCK_RESP_CODE_MIN		400
#define TR104I_CALL_POLICY_BOOK_BLOCK_RESP_CODE_MAX		699
#define TR104I_CALL_POLICY_BOOK_BLOCK_RESP_CODE_DEFAULT	488

/* The definition for VoicePhoneBookCallPolicyBook_t.phoneNumberCheckLogic */
typedef enum callPolicyBookNumberCheckLogic_es
{
	TR104I_CALL_POLICY_BOOK_NUMBER_CHECK_LOGIC_BASIC = 0,
	TR104I_CALL_POLICY_BOOK_NUMBER_CHECK_LOGIC_E164SUPPORT, // 1
	TR104I_CALL_POLICY_BOOK_NUMBER_CHECK_LOGIC_MAX
} callPolicyBookNumberCheckLogic_et;

#define TR104S_CALL_POLICY_BOOK_NUMBER_CHECK_LOGIC_BASIC		"Basic"
#define TR104S_CALL_POLICY_BOOK_NUMBER_CHECK_LOGIC_E164SUPPORT	"E164Support"

#if ZYXEL_CALL_BLOCK_FUNC_SUPPORT_BLOCK_INTERNATIONAL_CALL
/* The definition is for VoicePhoneBookCallPolicyBook_t.blockInternationalCall */
typedef enum callPolicyBookBlockInternationalCall_es
{
	TR104I_CALL_POLICY_BOOK_CALL_BLOCK_INTERNATIONAL_CALL_DISABLED = 0,
	TR104I_CALL_POLICY_BOOK_CALL_BLOCK_OUTGOING_INTERNATIONAL_CALL,
	TR104I_CALL_POLICY_BOOK_CALL_BLOCK_INCOMING_INTERNATIONAL_CALL,
	TR104I_CALL_POLICY_BOOK_CALL_BLOCK_ALL_INTERNATIONAL_CALL
} callPolicyBookBlockInternationalCall_et;

#define TR104S_CALL_POLICY_BOOK_CALL_BLOCK_INTERNATIONAL_CALL_DISABLED		"Disabled"
#define TR104S_CALL_POLICY_BOOK_CALL_BLOCK_OUTGOING_INTERNATIONAL_CALL		"Outgoing"
#define TR104S_CALL_POLICY_BOOK_CALL_BLOCK_INCOMING_INTERNATIONAL_CALL		"Incoming"
#define TR104S_CALL_POLICY_BOOK_CALL_BLOCK_ALL_INTERNATIONAL_CALL		"AllDirection"
#endif //ZYXEL_CALL_BLOCK_FUNC_SUPPORT_BLOCK_INTERNATIONAL_CALL.

typedef struct VoicePhoneBookCallPolicyBookList_s {
	uint8	enable;
	char	phoneNumber[STR_LEN_128+1];
	char	unifiedPhoneNumber[STR_LEN_128+1];
	uint8	unifiedPhoneNumber_matchPrefixLen;
	uint8	direction;
	uint8	method;
	char	forwardToNumber[STR_LEN_128+1];
	char	description[STR_LEN_128+1];
} VoicePhoneBookCallPolicyBookList_t;

typedef struct VoicePhoneBookCallPolicyBook_s {
	uint32								callPolicyBookNumberOfEntries;
	uint8								type;
	callPolicyBookMode_et				incomingCallBlockMode;		//Determine how to block an incoming call. Anna 20210115
	uint32								incomingCallBlock_RespCode;	//Determine the response code for rejecting an incoming call when incomingCallBlockMode is SoftBlock. Anna 20210115
	callPolicyBookNumberCheckLogic_et	phoneNumberCheckLogic;		//Determine the method of checking the phone number. Anna 20210115
	char								exceptNumberList[256+1];	//List the phone number to be excluded from call blocking list. Anna 20210115
#if ZYXEL_CALL_BLOCK_FUNC_SUPPORT_BLOCK_INTERNATIONAL_CALL
	uint8								blockInternationalCall;
#endif
...
#if ZYXEL_VOIP_SIP_3GPP_IMS_ETSI_TS_183_043_DIAL_TONE_MANAGEMENT_SUPPORT //Michael.20191121.001: Add to support the 3GPP IMS Dial-tone Management feature (defined in the Spec. ETSI TS 183.043) Part-1: Construct a SIP Line/Acct-based Dial-tone Type Indicator and make ZyIMS play the Dial-tone with reference to it.
	/*** NOTE.20191216.Michael:
	 *** This 'dialToneType' was first designed to be dedicated-to and controlled-by the 3GPP IMS Dial-tone Management function.
	 *** However, in the future, it can be re-designed/used to serve as a Generic function to control the Dial-tone Type when the end-user Offhook the phone.
	 *** At that time, its value MUST be determined by considering All factors mattering with the "Dial-tone Type", or more precisely, the "Offhook Tone Type"
	 *** to hint the end-user about the situation/condition of the Outgoing call resource availability!
	 *** Meanwhile, the feature compile flag 'ZYXEL_VOIP_SIP_3GPP_IMS_ETSI_TS_183_043_DIAL_TONE_MANAGEMENT_SUPPORT' MUST also be remarked/removed!
	 *** So far, per our understanding, the factors mattering with the "Offhook Tone Type" should be: (a)the SIP Registration Status, (b)the MWI Status,
	 *** (c)the 'Local-side' CFU or DND function Enable Status, and (d)the 3GPP IMS Dial-tone Management Control Result of the (phone port's) related/associated SIP Acct.
	 ***/
	uint8	dialToneType; //tr104_object.h/TONE_EVENT_XXXXXX.
#endif //ZYXEL_VOIP_SIP_3GPP_IMS_ETSI_TS_183_043_DIAL_TONE_MANAGEMENT_SUPPORT.
