...
void *zyCalloc(unsigned int cnt, unsigned int size); //Michael.20220410.003: Add to Merge RD-Ado's modification(s) to Avoid [voiceApp]/[mm.exe] Crashes because of the (Possible Root Cause) 'Memory Address Error' under the Full 64-bit operation system.
...
char *zyStrtok_r(char * p_source, const char * p_delimiters, char ** p_saved_source); //Amber.20200213.Add.
