...
/*CSR00153196 error cause on rejecting incoming fax request*/
#define ICF_CAUSE_INCOMING_FAX_REJECT		    ICF_ERROR_START_CFG +  124

#define ICF_ERROR_END_CFG                           ICF_ERROR_START_CFG +  125
