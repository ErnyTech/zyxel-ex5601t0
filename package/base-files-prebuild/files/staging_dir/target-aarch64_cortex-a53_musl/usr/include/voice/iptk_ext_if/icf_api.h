...
/*CSR00154942 fix starts*/
     /* Contains the authentication key configured per line. */
     icf_auth_string_st                 authentication_key;

     /* Contains the authentication password configured per line.*/
     icf_auth_string_st                 authentication_password;
/*CSR00154942 fix ends*/
...
/*CSR_00157092 Enahancement*/
#define ICF_SET_CALL_PRM_IGNORE_PAI_HDR	 0x000001000
...
typedef struct
{
	 ...
	 */
	icf_fax_start_type_t   fax_type;
	/* CSR00153196 - Error cause is set if result is failure*/
	icf_error_t			   error_cause;
