...
/*
 * Data body for CMS_MSG_FTP_USER_INFO message type.
 */
typedef struct
{
   char username[257];	/**< username of user */
   char password[257];	/**< password of user */
   bool IsAllow;
} GetUserInfoMsgBody;
...
#define zcfgMsgReqRecv(_r_, _t_)                zcfg_msg_serverRecv(_r_, _t_, __FILE__, __LINE__)
#define zcfgMsgSendAndGetReply(_s_, _r_, _t_)   zcfg_msg_sendAndGetReply(_s_, _r_, _t_, __FILE__, __LINE__)

#define	zcfgMsgQueryCurrentEid()				zcfg_msg_eidGet()
