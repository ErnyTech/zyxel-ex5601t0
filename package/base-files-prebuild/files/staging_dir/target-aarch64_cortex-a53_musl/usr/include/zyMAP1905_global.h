...
#define BAND_TYPE_INV  0x0
#define BAND_TYPE_2G   0x1
#define BAND_TYPE_5GL  0x2
#define BAND_TYPE_5GH  0x4
...
typedef enum {
	...
	MEDIA_TYPE_IEEE802_11ax = 0x0108,	/**< IEEE 802.11ax (WiFi 6) */
...
#endif
	OPTION_WIFI_CLINET_BAND			= 9,      /**< Configuration option (OPTION_WIFI_CLINET_BAND) */
	OPTION_WIFI_CLINET_SNR          = 10      /**< Configuration option (OPTION_WIFI_CLINET_SNR) */
} WIFIClientOption;
