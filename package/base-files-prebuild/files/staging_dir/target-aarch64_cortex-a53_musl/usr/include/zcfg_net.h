...
#define DNSMASQ_DNS_CONF_FILE DNSMASQ_CONF_D"/dns.conf"
#define DNSMASQ_DNS_TRUST_ANCHOR_CONF_FILE DNSMASQ_CONF_D"/trust-anchors.conf"
...
#define TR98_G_FAST             "ADSL_G.FAST"
...
/*IPv6 MAP Transport Mode*/
#define TR181_MAP_TRANSLATION   "Translation"
#define TR181_MAP_ENCAPSULATION "Encapsulation"

#define MAX_DEFAULT_GATEWAY 8
#define MAX_ACTIVE_DNS_IP   4
#define MAX_DNSIFNAME       8

#define MAX_INTF_PATH_LENGTH 256
#define MAX_CMD_LENGTH       512
#define IPADDR_LENGTH  46
#define IP6ADDR_LENGTH 128
...
#define DIAG_COMPLETED                 "Completed"
...
#define DIAG_ERROR_TRANSFERFAILED       "Error_TransferFailed"
...
/*TrustDomain Mode*/
#define MODE_LAN_withoutWL			"LAN_withoutWL"
#define MODE_LAN_withoutWL_WAN		"LAN_withoutWL_WAN"
#define MODE_LAN_withoutWL_TstDm	"LAN_withoutWL_TstDm"
#define MODE_WL_WAN			"WL_WAN"
#define MODE_WL_Trust_Dm	"WL_Trust_Dm"
#define MODE_WL_ONLY		"WL_ONLY"
...
#define NTPCLIENT_FILE "ntpclient"
...
/*brctl bridgepriority*/
#define BRIDGE_DEFAULT_PRIORITY 0x8000
#define BRIDGE_EXTENDER_PRIORITY (BRIDGE_DEFAULT_PRIORITY | BRIDGE_DEFAULT_PRIORITY >> 1) /*0xC000*/

/*Default Extender IP Address */
//#define DEFAULT_EXTENDER_IP "192.168.1.2"
