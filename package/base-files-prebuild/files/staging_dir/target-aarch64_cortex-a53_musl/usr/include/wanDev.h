...
extern tr98Parameter_t para_RUNNINGWANConn[];
#endif
...
extern zcfgRet_t WANDeviceObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANDslIfaceCfgObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANEthIfaceCfgObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANDslDiagObjSet(char *, int, struct json_object *, struct json_object *, char *);
#endif
...
extern zcfgRet_t WANDslLinkConfObjSet(char *, int, struct json_object *, struct json_object *, char *);
#endif

#ifdef CONFIG_ZCFG_BE_MODULE_PTM_LINK
extern zcfgRet_t WANPtmLinkConfObjGet(char *, int, struct json_object **, bool);
extern zcfgRet_t WANPtmLinkConfObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
#ifdef ZYXEL_RUNNINGWAN_CUSTOMIZATION
extern zcfgRet_t RUNNINGWANConnObjGet(char *, int, struct json_object **, bool);
#endif
extern zcfgRet_t WANIpConnObjGet(char *, int, struct json_object **, bool);
extern zcfgRet_t WANIpConnObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t DhcpClientObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t DhcpClientSentOptObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t DhcpClientReqOptObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPppConnObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANConnMldObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPortMappingSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPortTriggerSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANAddrMappingSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANAtmF5LoConfObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANAtmF4LoConfObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANIpv6AddrObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANIpv6PrefixObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANIpv6DhcpV6ObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANIpv6RdObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPppv6AddrObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPppv6PrefixObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPppv6DhcpV6ObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t WANPppv6RdObjSet(char *, int, struct json_object *, struct json_object *, char *);
