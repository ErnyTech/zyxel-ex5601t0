...
#define PARAMETER_ATTR_EXTENDER_HIDDEN            (1 << 15)
...
#define OBJECT_ATTR_DELAY                         (1 << 9)      /* object should be delayed to apply if tr069 requests */
#define OBJECT_ATTR_EXTENDER_HIDDEN               (1 << 10)     /* Hide the object if extender is supported*/
