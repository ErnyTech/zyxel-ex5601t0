...
typedef enum
{
    ...
    TR069_INVALID_UUID_FORMAT = 9022,
	TR069_UNKNOWN_EXECUTIUON_ENVIRONMENT = 9023,
	TR069_DISABLED_EXECUTIUON_ENVIRONMENT = 9024,
	TR069_DEPLOYMENT_UNIT_TO_EXECUTIUON_ENVIRONMENT_MISMATCH = 9025,
    TR069_DUPLICATE_DEPLOYMENT_UNIT = 9026,
    TR069_SYSTEM_RESOURCES_EXCEEDED = 9027,
	TR069_UNKNOWN_DEPLOYMENT_UNIT = 9028,
    TR069_INVALID_DEPLOYMENT_UNIT_STATE = 9029,
	TR069_INVALID_DEPLOYMENT_UNIT_UPDATE_DOWNGRADE_NOT_PERMITTED = 9030,
    TR069_INVALID_DEPLOYMENT_UNIT_UPDATE_VERSION_NOT_SPECIFIED = 9031,
	TR069_INVALID_DEPLOYMENT_UNIT_UPDATE_VERSION_ALREADY_EXISTS = 9032
	/* 9800 - 9899: Vendor defined fault codes */
	/* RPC Fault Code*/
	,TR069_FILE_TRANSFER_FAILURE_SAME_FW = 9800
