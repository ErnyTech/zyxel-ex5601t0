...
#define zcfgLog _zcfgLog
#define zcfgLogPrefix  _zcfgLogPrefix

#if ZCFG_LOG_USE_SYSLOG
#define _zcfgLog(logLev, format, ...) \
                if(ZCFG_LOG_LEVEL >= logLev) \
                        syslog(logLev, format, ##__VA_ARGS__)
#define _zcfgLogPrefix(logLev, Prefix, format, ...) \
                if(ZCFG_LOG_LEVEL >= logLev) \
...
#define _zcfgLog(logLev, format, ...) zcfgDebug(logLev, format, ##__VA_ARGS__)
#define _zcfgLogPrefix(logLev, PreFix, format, ...) zcfgDebug(logLev, PreFix " " format, ##__VA_ARGS__)
#elif ZCFG_ZYUTIL_DYNAMIC_DEBUG_API
void zyUtilDebug(int , const char *,...);
#define _zcfgLog(logLev, format, ...) zyUtilDebug(logLev, format, ##__VA_ARGS__)
#define _zcfgLogPrefix(logLev, PreFix, format, ...) zyUtilDebug(logLev, PreFix " " format, ##__VA_ARGS__)
#else
#define _zcfgLog(logLev, format, ...) {if(myDebugCfgObj){\
...
#define _zcfgLogPrefix(logLev, PreFix, format, ...) {if(myDebugCfgObj){\
