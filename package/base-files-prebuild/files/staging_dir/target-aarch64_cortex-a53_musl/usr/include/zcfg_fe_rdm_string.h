...
#define zcfgFeObjJsonGetNext(oid, objIid, value) _zcfgFeObjJsonGetNext(oid, objIid, value, __FILE__, __LINE__)
#define zcfgFeObjJsonGetNextWithoutUpdate(oid, objIid, value) _zcfgFeObjJsonGetNextWithoutUpdate(oid, objIid, value, __FILE__, __LINE__)
#define zcfgFeObjJsonGet(oid, objIid, value) _zcfgFeObjJsonGet(oid, objIid, value, __FILE__, __LINE__)
#define zcfgFeObjJsonGetWithoutUpdate(oid, objIid, value) _zcfgFeObjJsonGetWithoutUpdate(oid, objIid, value, __FILE__, __LINE__)
#define zcfgFeSubInObjJsonGetNext(oid, objIid, insIid, value) _zcfgFeSubInObjJsonGetNext(oid, objIid, insIid, value, __FILE__, __LINE__)
#define zcfgFeSubInObjJsonGetNextWithoutUpdate(oid, objIid, insIid, value) _zcfgFeSubInObjJsonGetNextWithoutUpdate(oid, objIid, insIid, value, __FILE__, __LINE__)
#define zcfgFeWholeObjJsonGet(tr181path, value) _zcfgFeWholeObjJsonGet(tr181path, value, __FILE__, __LINE__)

zcfgRet_t _zcfgFeObjJsonGetNext(zcfg_offset_t, objIndex_t *, struct json_object **, const char *, int);
zcfgRet_t _zcfgFeObjJsonGetNextWithoutUpdate(zcfg_offset_t , objIndex_t *, struct json_object **, const char *, int);
zcfgRet_t _zcfgFeObjJsonGet(zcfg_offset_t, objIndex_t *, struct json_object **, const char *, int);
zcfgRet_t _zcfgFeObjJsonGetWithoutUpdate(zcfg_offset_t, objIndex_t *, struct json_object **, const char *, int);
zcfgRet_t _zcfgFeSubInObjJsonGetNext(zcfg_offset_t oid, objIndex_t *objIid, objIndex_t *insIid, struct json_object **value, const char *, int);
zcfgRet_t _zcfgFeSubInObjJsonGetNextWithoutUpdate(zcfg_offset_t , objIndex_t *, objIndex_t *, struct json_object **, const char *, int);
zcfgRet_t _zcfgFeWholeObjJsonGet(char *tr181path, struct json_object **, const char *, int);
