...
extern zcfgRet_t qMgmtSet(char *, int, struct json_object *, struct json_object *, char *paramfault);
...
extern zcfgRet_t qMgmtQueSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t qMgmtClsSet(char *, int, struct json_object *, struct json_object *, char *paramfault);
...
extern zcfgRet_t qMgmtShaperSet(char *, int, struct json_object *, struct json_object *, char *);
