...
tr98Parameter_t para_LanHostConfMgmt[] = {
	...
	{ "DHCPServerConfigurable", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    0, json_type_boolean},
	{ "DHCPServerEnable",       PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    0, json_type_boolean},
	{ "DHCPRelay",              PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	{ "MinAddress",             PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    17, json_type_string},
	{ "MaxAddress",             PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    17, json_type_string},
	{ "ReservedAddresses",      PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    257, json_type_string},
	{ "SubnetMask",             PARAMETER_ATTR_WRITE                                 ,    17, json_type_string},
	{ "DNSServers",             PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    65, json_type_string},
	{ "DomainName",             PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    65, json_type_string},
	{ "IPRouters",              PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    65, json_type_string},
	{ "DHCPLeaseTime",          PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN,    0, json_type_int},
	...
	{ "DHCPStaticAddressNumberOfEntries",   PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "DHCPOptionNumberOfEntries",          PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "DHCPConditionalPoolNumberOfEntries", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "X_ZYXEL_DNS_Type",                   PARAMETER_ATTR_WRITE    | PARAMETER_ATTR_EXTENDER_HIDDEN, 16, json_type_string},
#ifdef SAAAD_STB_PROVISION
...
tr98Parameter_t para_IpIntf[] = {	
	...
	{ "X_ZYXEL_ConnectionId", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 17, json_type_int},
	{ "X_ZYXEL_IPR2_MARKING", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 17, json_type_uint32},
	{ "X_ZYXEL_Group_WAN_IpIface", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 1500, json_type_string},
	...
	{ "X_ZYXEL_IPv6IdentifierType", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 17, json_type_string},
	{ "X_ZYXEL_IPv6Identifier", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 33, json_type_string},
...
#endif
	{ "X_ZYXEL_PubLan", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	{ "X_ZYXEL_PubLan_DHCP", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	{ "X_ZYXEL_PubLan_ARP", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	{ "X_ZYXEL_PubLan_IP", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 16, json_type_string},
	{ "X_ZYXEL_PubLan_Mask", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 16, json_type_string},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_DhcpCondServPoolDhcpOpt[] = {	
	...
	{ "Value", PARAMETER_ATTR_WRITE, 256+(256/2), json_type_base64},
#endif
	{ "X_ZYXEL_SubTag", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_LanEthIntfConf[] = {	
	...
	{ "X_ZYXEL_CurrentBitRate", PARAMETER_ATTR_READONLY, 7, json_type_string},
...
tr98Parameter_t para_LanDevWlanCfg[] = {
	...
	{ "MaxBitRate", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 5, json_type_string},
	...
	{ "WEPKeyIndex", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	//{ "KeyPassphrase", PARAMETER_ATTR_WRITE, 64, json_type_string},
	{ "WEPEncryptionLevel", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 65, json_type_string},
	...
	{ "BeaconAdvertisementEnabled", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	...
	{ "TotalPSKFailures", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	...
	{ "AuthenticationServiceMode", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 20, json_type_string},
	...
	{ "X_ZYXEL_OperatingStandards", PARAMETER_ATTR_WRITE, 16, json_type_string},
	{ "X_ZYXEL_Auto_Channel_Skip", PARAMETER_ATTR_WRITE, 101, json_type_string},
#ifdef ABUU_CUSTOMIZATION
	{ "X_ZYXEL_AirtimeFairness", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif
#ifdef ONECONNECT
	{ "X_ZYXEL_AP_AutoConfig", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif
	{ "X_ZYXEL_AutoGenWepKey", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
...
#endif
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069
	{ "MaxAssociatedDevices", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
#endif
#ifdef ZYXEL_WLAN_BLOCK_OPEN
	{ "X_ZYXEL_WlanBlockEnable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif
#ifdef ZYXEL_WLAN_WORK_24_HOURS
	{ "X_ZYXEL_Work24HoursEnable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif
#ifdef ZYXEL_CONFIG_MAX_WLAN_CLIENT
	{ "X_ZYXEL_MaxAssociatedDevices", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
#endif
...
#endif
	{ "X_ZYXEL_InActiveChannels", PARAMETER_ATTR_WRITE, 129, json_type_string},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_LanDevWlanCfgStat[] = {
	...
	{ "UnknownProtoPacketsReceived", PARAMETER_ATTR_READONLY, 0, json_type_uint32},	
#ifdef CONFIG_TAAAB_CUSTOMIZATION_TR069
	{ "X_TTNET_ChannelUtilization", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "X_TTNET_RetransCount", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
#endif
	{ NULL, 0, 0, 0}
...
tr98Parameter_t para_LanDevWlanCfgAssocDev[] = {
	...
	{ "AssociatedDeviceAuthenticationState", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_boolean},
	...
	{ "X_ZYXEL_LastDataDownlinkRate", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "X_ZYXEL_Retransmissions", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
#ifdef ABZQ_CUSTOMIZATION_WLAN_INFO
	{ "ConnectedTime", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "OperatingStandard", PARAMETER_ATTR_READONLY, 12, json_type_string},
	{ "LastDataDownlinkRate", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "LastDataUplinkRate", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
#endif
...
tr98Parameter_t para_LanDevWlanCfgAssocDevStat[] = {
	...
	{ "PacketsReceived", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ErrorsSent", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "RetransCount", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "FailedRetransCount", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "RetryCount", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ "MultipleRetryCount", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_NeiborWifiDiagResult[] = {
	...
	{ "MaxPhyRate", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ "ExtensionChannel", PARAMETER_ATTR_READONLY, 20, json_type_string},
	{ "RSSI", PARAMETER_ATTR_READONLY, 0, json_type_int},
#ifdef ZYXEL_WIND_ITALY_CUSTOMIZATION
	{ "SignalQuality", PARAMETER_ATTR_READONLY, 17, json_type_string},
...
tr98Parameter_t para_Host[] = {
	...
	{ "VendorClassID", PARAMETER_ATTR_READONLY | PARAMETER_ATTR_EXTENDER_HIDDEN, 256, json_type_string},
	{ "ClientID", PARAMETER_ATTR_READONLY      | PARAMETER_ATTR_EXTENDER_HIDDEN, 5, json_type_string},
	{ "UserClassID", PARAMETER_ATTR_READONLY   | PARAMETER_ATTR_EXTENDER_HIDDEN, 5, json_type_string},
	...
	{ "X_ZYXEL_LastDataDownlinkRate", PARAMETER_ATTR_READONLY, 0, json_type_int},
	{ "X_ZYXEL_LastDataUplinkRate", PARAMETER_ATTR_READONLY, 0, json_type_int},
	{ "X_ZYXEL_OperatingFrequencyBand", PARAMETER_ATTR_READONLY, 8, json_type_string},
#ifdef ZYXEL_WEB_GUI_HOST_PRIORITY_STATICIP
	{ "X_ZYXEL_PriorityTraffic_Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
#endif //ZYXEL_WEB_GUI_HOST_PRIORITY_STATICIP
	{ "X_ZYXEL_Internet_Lock_Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ NULL, 0, 0, 0}
};
