...
#define MAX_MAP_NEIGHBOR_IN_DB 5
#define ZYFLAGS_AUTO_ROLE_SELECTION 0x0001
#define ZYFLAGS_AUTO_ROLE_SELECTION_ONLY_WHEN_GW_FOUND 0x0002
#define ZYFLAGS_AP_MODE 0x0004
#define ZYFLAGS_REPEATER_MODE 0x0008
#define NEIGHBOR_TIMEOUT_DEL_TIME 600   // This is ref to hosts host object delete time

extern unsigned int zyFlags;
...
typedef struct {
  ...
  time_t  zy1905versionChangeTime;
} zyDevConfTable;
...
void zyMAP1905_param_update();

void registerMAPNeighbor(UINT8 *alMac);
#endif
