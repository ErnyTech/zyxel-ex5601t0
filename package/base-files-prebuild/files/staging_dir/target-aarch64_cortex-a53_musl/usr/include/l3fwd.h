...
extern zcfgRet_t l3fwdFwdTbObjSet(char *, int, struct json_object *, struct json_object *, char *);
...
extern zcfgRet_t l3fwdIpv6FwdTbObjSet(char *, int, struct json_object *, struct json_object *, char *);
